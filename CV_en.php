...
<head>
    ...
    <link rel="alternate" href="localhost/CV/" hreflang="tr-TR" />
        ...
        <div class="row">
                ...
                <div class="row mt-4 text-center">
                    ...
                    <div class="col-12">
                        ...
                        <div class="mt-3 preview">
                            <button class="btn btn-success" onclick="addRow('communicationList');">Add</button>
                            <button class="btn btn-danger" onclick="deleteListRow('communicationList',2);">Delete</button>
                        </div>
                    </div>
                </div>
                <div class="row mt-4 text-center">
                    ...
                    <div class="col-12">
                        ...
                        <div class="mt-3 preview">
                            <button class="btn btn-success" onclick="addRow('personalList');">Add</button>
                            <button class="btn btn-danger" onclick="deleteListRow('personalList',1);">Delete</button>
                        </div>
                    </div>
                </div>
                <div class="row mt-4 text-center">
                    ...
                    <div class="col-12">
                        ...
                        <div class="mt-3 preview">
                            <button class="btn btn-success" onclick="addRow('languageList');">Add</button>
                            <button class="btn btn-danger" onclick="deleteListRow('languageList',1);">Delete</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="mt-1 p-1 preview">
                                <div class="row w-100 justify-content-center">
                                    ...
                                    <button class="btn btn-success ml-1" onclick="addSkill('skills');">Add</button>
            ...
            <div class="col-md-7 align-self-center">
                <div class="row mt-5">
                    ...
                    <div class="col-md-5 d-flex justify-content-end">
                        <div class="align-self-center preview">
                            <button class="btn bg-indigo text-light" onclick="addRow('educationList');">Add Row</button>
                            <button class="btn btn-danger btn-sml" onclick="deleteListRow('educationList',1);">Delete</button>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-5 d-flex justify-content-end">
                        <div class="align-self-center preview">
                            <button class="btn bg-indigo text-light" onclick="addRow('projectsList');">Add Row</button>
                            <button class="btn btn-danger btn-sml" onclick="deleteListRow('projectsList',1);">Delete</button>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-5 d-flex justify-content-end">
                        <div class="align-self-center preview">
                            <button class="btn bg-indigo text-light" onclick="addRow('expList');">Add Row</button>
                            <button class="btn btn-danger btn-sml" onclick="deleteListRow('expList',1);">Delete</button>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row mt-5 justify-content-center">
                    ...
                    <div class="mt-3 preview">
                        <button class="btn btn-warning" onclick="removeSkillArea('AllSkills','A')">Delete Column</button>
                        <button class="btn bg-indigo text-light" onclick="addSkillArea('AllSkills','A');">Add Column</button>
                    </div>
                </div>
                <div class="row mt-5 justify-content-center">
                    <div class="m-auto">
                    ...
                    <div class="mt-3 preview">
                        <button class="btn btn-warning" onclick="removeSkillArea('Hobbies','B');">Delete Column</button>
                        <button class="btn bg-indigo  text-light" onclick="addHobbiesArea('Hobbies','B');">Add Column</button>
                    </div>
                </div>
            </div>
        </div>
